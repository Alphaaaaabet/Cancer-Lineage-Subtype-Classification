...
# TODO: Update bash script to include drug_features
def train_model(root, term_size_map, term_direct_gene_map, dG, train_data,
                ...
                cell_features_1, cell_features_2, drug_features):
    ...
    for epoch in range(train_epochs):
        ...
        for i, (inputdata, labels) in enumerate(train_loader):
            ...
            # 
            features_1 = build_input_vector(inputdata, cell_features_1, drug_features)
            features_2 = build_input_vector(inputdata, cell_features_2, drug_features)
...
# load input data
train_data, cell2id_mapping, drug2id_mapping = prepare_train_data(opt.train, opt.test,
                                                 opt.cell2id, opt.drug2id)
...
train_model(root, term_size_map, term_direct_gene_map, dG, train_data,
            ...
            num_hiddens_features, num_hiddens_drug, num_hiddens_final, 
            cell_features_1, cell_features_2, drug_features)
